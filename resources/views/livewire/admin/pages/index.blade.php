                    ...
                    <tr>
                        <th scope="col"
                            ...
                            <button type="button" wire:click="sortBy('title')"
                                class="inline-flex items-center gap-1">{{ __('Title') }}</button>
                        </th>
                        <th scope="col"
                            class="px-4 py-2 text-left font-semibold text-neutral-700 dark:text-neutral-200">
                            {{ __('Slug') }}</th>
                ...
                <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
                    @forelse ($pages as $page)
                        <tr wire:key="page-{{ $page->id }}">
                            <td class="px-4 py-2 font-medium text-neutral-900 dark:text-neutral-50">{{ $page->title }}
                            </td>
